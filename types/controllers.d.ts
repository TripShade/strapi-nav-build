...
export interface IAdminController {
    ...
    put: StrapiController<Promise<Navigation>, Navigation, never, {
        id: string;
    }, ControllerCommonContext>;
    delete: StrapiController<Promise<Navigation>, never, never, {
        id: string;
    }, ControllerCommonContext>;
    ...
    fillFromOtherLocale: StrapiController<Promise<Navigation>, never, never, {
        source: string;
        target: string;
    }, ControllerCommonContext>;
    readNavigationItemFromLocale: StrapiController<Promise<Partial<Pick<NotVoid<Navigation["items"]>[number], "path" | "related" | "type" | "uiRouterKey" | "title" | "externalPath">>>, never, {
        path?: string;
    }, {
        source: string;
        target: string;
    }, ControllerCommonContext>;
    getSlug: StrapiController<Promise<{
        slug: string;
    }>, never, {
        q: string;
    }>;
